class UI {
    ...
    displayIngredients(drink){
        ...
        ingredients.forEach(ingredients => {
            ingredientsTemplate += `
                 <li class="list-group-item">${ingredients.ingredients}-${ingredients.measure}</li>
            `;
        });
    ...
    displaySingleRecipe(recipe) {
        ...
        modalDescription.innerHTML = recipe.stringInstructions;

        // Display the ingredients
       
        modalIngredients.innerHTML = this.displaySingleRecipe(recipe);
    }
